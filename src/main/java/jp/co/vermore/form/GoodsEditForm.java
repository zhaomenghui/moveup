...
public class GoodsEditForm {
    ...
    private List<StockRegistForm> pastStock;
    ...
    public int getNewAmountId() {
        return newAmountId;
    }

    public void setNewAmountId(int newAmountId) {
        this.newAmountId = newAmountId;
    }

    public List<StockRegistForm> getPastStock() {
        return pastStock;
    }

    public void setPastStock(List<StockRegistForm> pastStock) {
        this.pastStock = pastStock;
    }
