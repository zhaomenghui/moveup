package jp.co.vermore.service.com.amazonaws.services.elastictranscoder.samples;
...
import jp.co.vermore.service.com.amazonaws.services.elastictranscoder.samples.model.JobStatusNotification;
import jp.co.vermore.service.com.amazonaws.services.elastictranscoder.samples.model.JobStatusNotificationHandler;
import jp.co.vermore.service.com.amazonaws.services.elastictranscoder.samples.utils.SqsQueueNotificationWorker;
import jp.co.vermore.service.com.amazonaws.services.elastictranscoder.samples.utils.TranscoderSampleUtilities;
...
public class JobStatusNotificationsSample {
    ...
    private static final String PIPELINE_ID = "moveup";
    ...
    private static final String SQS_QUEUE_URL = "https://sqs.ap-northeast-1.amazonaws.com/762828471420/moveup";
    
    // This is the name of the input key that you would like to transcode.
    private static final String INPUT_KEY = "test20180607.mp4";
    
    // This will generate a 480p 16:9 mp4 output.
    private static final String PRESET_ID = "1351620000001-000020";
    
    // All outputs will have this prefix prepended to their output key.
    private static final String OUTPUT_KEY_PREFIX = "tv/";
