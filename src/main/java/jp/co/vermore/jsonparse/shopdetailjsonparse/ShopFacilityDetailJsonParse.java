...
public class ShopFacilityDetailJsonParse extends BaseJsonParse {
    ...
    private String dayPriceLow;

    private String dayPriceHigh;

    private String nightPriceLow;

    private String nightPriceHigh;
    ...
    public String getDayPriceLow() {
        return dayPriceLow;
    }

    public void setDayPriceLow(String dayPriceLow) {
        this.dayPriceLow = dayPriceLow;
    }

    public String getDayPriceHigh() {
        return dayPriceHigh;
    }

    public void setDayPriceHigh(String dayPriceHigh) {
        this.dayPriceHigh = dayPriceHigh;
    }

    public String getNightPriceLow() {
        return nightPriceLow;
    }

    public void setNightPriceLow(String nightPriceLow) {
        this.nightPriceLow = nightPriceLow;
    }

    public String getNightPriceHigh() {
        return nightPriceHigh;
    }

    public void setNightPriceHigh(String nightPriceHigh) {
