        ...
        <div class="container">
            ...
            <div class="row col-lg-12 col-xs-12" align="center" style="height: 600px">
                ...
                <div class ="error">
                    ...
                    <div path="errorMessage" style="color:#F23B26" class="waring_Label col-lg-offset-4 col-xs-offset-1">${withdrawForm.errorMessage}</div>
                </div>
                <button type="submit" class="confirmBtn" name="confirm" value="Confirm">退会します</button>
            </div>
        </div>
    </section>
