...
<head>
    ...
    <%--<script src="/static/admin/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css"></script>--%>
    <!-- Custom Theme Style -->
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form modelAttribute="recruitForm" id="userForm" enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/recruit/update/"
                                           class="form-horizontal form-label-left" method="post">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-1 col-xs-12" for="">リンク：
                                        </label>
                                        <label class="control-label col-md-3 col-sm-1 col-xs-12" style="text-align: left;font-size: 14px;">
                                            <a  href="${pageContext.request.contextPath}/recruit/detail/${recruitForm.uuid}/">${pageContext.request.contextPath}/recruit/detail/${recruitForm.uuid}/</a>
                                        </label>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">管理店UUID：
                                        </label>
                                        <div class="col-md-2 col-sm-1 col-xs-12 ">
                                            <form:input type="text" name="shopUuid" id="" path="shopUuid" required="required"
                                                        class="form-control co2-md-1 col -sm-6 col-xs-12" value="${recruitForm.shopUuid}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <form:input type="hidden" id="recruitId" path="recruitId"
                                                    value="${recruitForm.recruitId}"/>
                                        <%--<form:input type="hidden" id="picUrl" path="picUrl"--%>
                                                    <%--value="${recruitForm.picUrl}"/>--%>
                                        <%--<form:input type="hidden" id="picUrl1" path="picUrl1"--%>
                                                    <%--value="${recruitForm.picUrl1}"/>--%>
                                        <%--<form:input type="hidden" id="picUrl2" path="picUrl2"--%>
                                                    <%--value="${recruitForm.picUrl2}"/>--%>
                                        <%--<form:input type="hidden" id="picUrl3" path="picUrl3"--%>
                                                    <%--value="${recruitForm.picUrl3}"/>--%>
                                        <%--<form:input type="hidden" id="picUrl4" path="picUrl4"--%>
                                                    <%--value="${recruitForm.picUrl4}"/>--%>
                                        <%--<form:input type="hidden" id="picUrl5" path="picUrl5"--%>
                                                    <%--value="${recruitForm.picUrl5}"/>--%>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">内容
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                            <form:input  id="content" path="content" name="content" type="hidden"
                                                         required="required"
                                                         class="form-control co2-md-7 col -sm-6 col-xs-12"
                                                         value="${recruitForm.content}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#contentEditor">
                                                        <div class="btn-group">
                                                ...
                                                <div id="contentEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-1 col-xs-12">
                                            <div class="col-md-12 col-sm-1 col-xs-12">
                                                <label class=" col-md-6 col-sm-1 col-xs-12" for="picFile">一覧に表示する画像
                                                    <span class="required">*</span>
                                                </label>
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-6 col-xs-12">
                                                <label class=" col-md-6 col-sm-1 col-xs-12" for="picFile1">メイン画像
                                                    <span class="required">*</span>
                                                </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-1 col-xs-12">
                                                <label class=" col-md-5 col-sm-1 col-xs-12" style="text-align: left;padding:0 5px;" for="picUrl2">サブ像1
                                                    <span class="required"></span>
                                                </label>
                                        ...
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-1 col-xs-12">
                                                <label class=" col-md-5 col-sm-1 col-xs-12" style="text-align: left;padding:0 5px;" for="picUrl3">サブ像2
                                                    <span class="required"></span>
                                                </label>
                                                <label class=" col-md-7 col-sm-3 col-xs-12">解像度: 500 X 500</label>
                                            </div>
                                        ...
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-1 col-xs-12">
                                                <label class=" col-md-5 col-sm-1 col-xs-12" style="text-align: left;padding:0 5px;" for="picUrl4">サブ像3
                                                    <span class="required"></span>
                                                </label>
                                                <label class=" col-md-7 col-sm-3 col-xs-12">解像度: 500 X 500</label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <div class="col-md-12 col-sm-1 col-xs-12">
                                                <label class=" col-md-5 col-sm-1 col-xs-12" style="text-align: left;padding:0 5px;" for="picUrl5">サブ像4
                                                    <span class="required"></span>
                                                </label>
                                                <label class=" col-md-7 col-sm-3 col-xs-12">解像度: 500 X 500</label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">業種<span
                                                class="required">*</span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">勤務時間 <span
                                                class="required"></span>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">勤務期間 <span
                                                class="required"></span>
                                        </label>
                                        <div class="col-md-6 col-sm-9 col-xs-12 checkbox-list">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">給与 <span
                                                class="required">*</span>
                                        </label>
                                        <%--<div class="col-md-6 col-sm-7 col-xs-12 ">--%>
                                        ...
                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                            <form:input  id="salaryFull" path="salaryFull" name="" type="hidden"
                                                         ...
                                                         value="${recruitForm.salaryFull}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#salaryFullEditor">
                                                        <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                        </ul>
                                                ...
                                                <div id="salaryFullEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">資格 <span
                                                class="required">*</span>
                                        </label>
                                        <%--<div class="col-md-6 col-sm-7 col-xs-12 ">--%>
                                        ...
                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                            <form:input  id="capacity" path="capacity" name="" type="hidden"
                                                         ...
                                                         value="${recruitForm.capacity}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#capacityEditor">
                                                        <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                        </ul>
                                                ...
                                                <div id="capacityEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">休日・休暇
                                            <span class="required">*</span>
                                        </label>
                                        <%--<div class="col-md-6 col-sm-7 col-xs-12 ">--%>
                                        ...
                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                            <form:input  id="vacation" path="vacation" name="" type="hidden"
                                                         ...
                                                         value="${recruitForm.vacation}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#vacationEditor">
                                                        <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                        </ul>
                                                ...
                                                <div id="vacationEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">福利厚生
                                            <span class="required">*</span>
                                        </label>
                                        <%--<div class="col-md-6 col-sm-7 col-xs-12 ">--%>
                                            ...
                                            <%--<form:textarea type="textarea" id="treatment" path="treatment" required="required"--%>
                                                        <%--class="form-control col-md-3 col-xs-12 " cssStyle="height: 120px"--%>
                                        ...
                                        <div class="col-md-6 col-sm-9 col-xs-12">
                                            <form:input  id="treatment" path="treatment" name="" type="hidden"
                                                         ...
                                                         value="${recruitForm.treatment}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#treatmentEditor">
                                                        <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                        </ul>
                                                ...
                                                <div id="treatmentEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">仕事内容<span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-7 col-xs-12">
                                            <form:input id="desc" required="required" path="desc" name="textarea" type="hidden"
                                                           class="form-control col-md-7 col-xs-12" style="height: 500px"
                                                           value="${recruitForm.desc}"></form:input>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#descEditor">
                                                        <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                        </ul>
                                                ...
                                                <div id="descEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1 col-sm-1 col-xs-12"></div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">関連、系列グループ店舗
                                            <span class="required"></span>
                                        </label>
                                        <div class="col-md-6 col-sm-7 col-xs-12 ">
                                            <form:input name="workingDate" id="workingDate" path="workingDate" required="required" type="hidden"
                                                        class="form-control col-md-3 col-xs-12 "
                                                        value="${recruitForm.workingDate}"/>
                                            <div class="x_content">
                                                <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#workingDateEditor">
                                                    <div class="btn-group">
                                                        <a class="btn dropdown-toggle" data-toggle="dropdown" title="Font Size"><i class="fa fa-text-height"></i>&nbsp;<b class="caret"></b></a>
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                ...
                                                <div id="workingDateEditor" class="editor-wrapper placeholderText" contenteditable="true"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
...
<script>
    ...
    $('#picFile').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove': false, 'dropZoneTitle':'','showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":550,"maxImageWidth":550,"minImageHeight":350,"maxImageHeight":350
    ...
    $('#picFile1').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove': false, 'dropZoneTitle':'','showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":1100,"maxImageWidth":1100,"minImageHeight":400,"maxImageHeight":400
    ...
    $userForm.validate({
        submitHandler: function(form) {
            ...
            $("#desc").val($('#descEditor').html());
            $("#salaryFull").val($('#salaryFullEditor').html());
            $("#capacity").val($('#capacityEditor').html());
            $("#vacation").val($('#vacationEditor').html());
            $("#treatment").val($('#treatmentEditor').html());
            $("#workingDate").val($('#workingDateEditor').html());
            $('#recruitLoading').show();
            $(form).submit();
        },
    ...
    $('#descEditor').html($("#desc").val());
    $("#workingDateEditor").html($('#workingDate').val());
    $('#salaryFullEditor').html($("#salaryFull").val());
    $('#capacityEditor').html($("#capacity").val());
    $('#vacationEditor').html($("#vacation").val());
    $('#treatmentEditor').html($("#treatment").val());
