                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <br/>
                                <form:form modelAttribute="form" id="userForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/freepaper/update/"
                                           class="form-horizontal form-label-left">
                                    <form:hidden path="id" ></form:hidden>
                                <div class="item form-group" >
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for="">日付 <span
                                            class="required">:</span>
                                    </label>

                                    <div class="col-md-2 col-sm-6 col-xs-12">
                                        <%--<label class="control-label " style="text-align: left"><c:out value="${form.date}"/></label>--%>
                                        <form:input path="date" id="date" class="form-control col-md-2 col-xs-12"
                                                    name="date" required="required" type="date"
                                                    value="${form.date}"/>
                                    </div>
                                    <label class="control-label col-md-1 col-sm-3 col-xs-12" for="">ボリューム<span
                                            class="required">:</span>
                                    </label>

                                    <div class="col-md-2 col-sm-6 col-xs-12">
                                        <%--<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left"><c:out value="${form.volume}"/></label>--%>
                                        <form:input path="volume" id="volume" class="form-control col-md-3 col-xs-12"
                                                    name="volume" required="required" type="text"
                                                    value="${form.volume}"/>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-sm-6 col-xs-12">
                                        <form:input path="sortScore" id="sortScore" class="form-control col-md-7 col-xs-12"
                                                    ...
                                                    value="${form.sortScore}"/>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="">タイトル <span class="required">:</span></label>
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                        <%--<label class="control-label col-md-3 col-sm-3 col-xs-12" style="text-align: left"><c:out value="${form.title}"/></label>--%>
                                        <form:input path="title" id="title" class="form-control col-md-3 col-xs-12"
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-2 col-sm-1 col-xs-12" for="">内容
                                        <span class="required">:</span>
                                    </label>
                                    <div class="col-md-8 col-sm-7 col-xs-12 ">
                                        <%--<form:input type="file" id="picFil" path="picFil" required=""--%>
                                                    <%--class="form-control col-md-3 col-xs-12" multiple="multiple"/>--%>
                                        <c:forEach items="${form.urlList}" var="url">
                                            <div class="col-md-2 col-sm-1 col-xs-12">
                                                <%--<iframe src="${url}" class='file-preview-image kv-preview-data' height="480px"--%>
                                                      <%--style='border: none;margin-bottom: 20px;' alt='' title=''/>--%>
                                                <%--<object data="${url}#page=1" type="application/pdf" width="100%" height="240px">--%>
                                                    <%--<a href="${url}"/>--%>
                                                <%--</object>--%>
                                                 <div><img src="${url}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-primary" href="/admin/freepaper/list/" style="width: 100px;">キャンセル</a>
...
<div id="freepagerLoading" style="display: none" class="loading">
