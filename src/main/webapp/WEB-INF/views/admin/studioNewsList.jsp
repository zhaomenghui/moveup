                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/studio/regist/"
                                       style="width: 100px;margin-left: 17px;" onclick="gotoRegist()"><span class="glyphicon glyphicon-plus"
                                ...
                                <div class="table-responsive">
                                    <table id="studioListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
...
<div id="studioLoading" style="display: none" class="loading">
    <div class="loading-text">Processing...</div>
</div>
<div class="modal fade delete-studio-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#studioListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/studio/list/',
            type: 'POST',
            data: function (data) {
                data.type = $('#type').val();
                data.date = $('#date').val();
    ...
    function gotoDelete(id) {
        currDeleteNewsId = id;
        $('.delete-studio-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#studioLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/studio/edit/' + id + '/';
    }

    <%--function gotoRegistEntryMail(id) {--%>
        <%--$('#eventLoading').show();--%>
        <%--window.location.href =  '${pageContext.request.contextPath}/admin/entrymail/regist/'+ id + '/';--%>
    <%--}--%>

    function gotoRegist() {
        $('#studioLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/studio/regist/';
    }

    function confirmDeleteClick() {
        $('.delete-studio-modal').modal("hide");
        $('#studioLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/studio/delete/');
