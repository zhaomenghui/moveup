                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                               ...
                               <form:form modelAttribute="form" id="userForm" enctype="multipart/form-data"
                                          action="${pageContext.request.contextPath}/admin/place/regist/"
                                   ...
                                   <%--<div class="item form-group" id="shopRadio" >--%>
                                       ...
                                       <%--<div class="radio" id="radio" onchange="search()">--%>
                                           <%--<label>--%>
                                               <%--<form:radiobutton path="adminShop" checked="" value="1"--%>
                                       ...
                                       <%--</div>--%>
                                   <%--</div>--%>
                                   <%--<div class="item form-group"  id="searchId" >--%>
                                       <%--<label class="control-label col-md-3 col-sm-1 col-xs-12" for="">管理店ID：--%>
                                       <%--</label>--%>
                                   ...
                                   <div class="item form-group" id="desc4" >
                                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">最寄駅<span
                                               class="required">*</span>
                                       </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:input path="station" id="station" class="form-control col-md-7 col-xs-12"
                                                       name="station" required="" type="text"/>
                                       </div>
                                       <label class="control-label col-md-1 col-sm-3 col-xs-12" for="">最寄駅徒歩時間<span
                                               class="required">*</span>
                                       </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:input path="walk" id="walk" class="form-control col-md-7 col-xs-12"
                                                       name="walk" required="" type="text"/>
                                       </div>
                                   </div>
                                   <div class="item form-group" id="tel" >
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:input path="time" id="time" class="form-control col-md-7 col-xs-12"
                                       ...
                                       <%--</label>--%>
                                       <%--<div class="col-md-2 col-sm-6 col-xs-12">--%>
                                           <%--<form:input path="holiday" id="holiday" class="form-control col-md-7 col-xs-12"--%>
                                                       <%--name="holiday" required="required" type="text"/>--%>
                                       <%--</div>--%>
                                   </div>
                                   ...
                                   <div class="item form-group">
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <input  id="coordinate1"  class="form-control col-md-7 col-xs-12"
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <input  id="coordinate2" class="form-control col-md-7 col-xs-12" name="coordinate2"
                                   ...
                                   <div class="item form-group" id="desc6" >
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                           <form:input path="address" id="address" class="form-control col-md-7 col-xs-12"
                                   ...
                                   <div class="item form-group" id="excerpt">
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-12">
                                           <form:textarea path="introduce" id="introduce"
                                                       class="form-control col-md-7 col-xs-12" name="introduce"
                                                       required="required" type="text"/>
                                       </div>
                                   </div>
                                   <div class="item form-group" id="desc1" >
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-12" style="height: 350px;">
                                           <form:input path="desc" id="desc" class="form-control col-md-7 col-xs-12"
                                   ...
                                   <div class="item form-group" id="File6">
                                   ...
                                   <div class="item form-group"  id="publishDate">
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <input  type="date" id="publishStart" name="publishStart"
                                                   class="form-control col-md-7 col-xs-12"/>
                                       </div>
                                       <label class="control-label col-md-1 col-sm-3 col-xs-12" for="publishEnd">掲載終了日 </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <input  type="date" id="publishEnd" name="publishEnd"
                                                   class="form-control col-md-7 col-xs-12"/>
                                       </div>
                                   </div>
...
<script>
    ...
    <%--$('#picFile6').fileinput({--%>
        <%--'language':'ja', 'showClose': true, 'showRemove':faluse, 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":360,"maxImageWidth":360,"minImageHeight":230,"maxImageHeight":230--%>
    ...
    $('#picFile12').fileinput({
        'language':'ja', 'showClose': false,'showCaption':false, 'showRemove':false, 'dropZoneTitle':'',    'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":350,"maxImageWidth":350,"minImageHeight":230,"maxImageHeight":230
