                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                               <form:form modelAttribute="roleFrom" id="roleFrom" enctype="multipart/form-data"
                                   ...
                                   <div class="item form-group">
                                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">ユーザータイプ <span
                                               class="required">*</span>
                                       </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:select path="type" id="type" value="${roleFrom.type}"
                                                        class="form-control col-md-7 col-xs-12" name=""
                                                        required="required" type="">
                                               <form:option value="1">管理ユーザー</form:option>
                                               <form:option value="2">お客様管理</form:option>
                                           </form:select>
                                       </div>
                                       <label class="control-label col-md-1 col-sm-3 col-xs-12" for="">ステータス<span
                                               class="required">*</span>
                                       </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:select path="status" id="desc4" value="${roleFrom.status}"
                                                        class="form-control col-md-7 col-xs-12"
                                                        name="" required="" type="text">
                                               <form:option value="0">--</form:option>
                                               <form:option value="1">有効</form:option>
                                               <form:option value="2">無効</form:option>
                                           </form:select>
                                       </div>
                                   </div>
                                   <div class="item form-group" id="" >
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:select path="privilege" id="privilege" value="${roleFrom.privilege}"
                                   ...
                                   <div class="item form-group" id="" >
                                       ...
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <%--<form:label path="customerType" id="customerType" value="${roleFrom.customerType}" class="form-control col-md-7 col-xs-12"--%>
                                                        <%--name="customerType" required="" type="">--%>
                                               <c:if test="${roleFrom.customerType == 0} ">
                                                   <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left">--</label>
                                               </c:if>
                                               <c:if test="${roleFrom.customerType == 1}">
                                                   <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left">店舗</label>
                                               </c:if>
                                               <c:if test="${roleFrom.customerType == 2}">
                                                   <label class="control-label col-md-12 col-sm-3 col-xs-12" style="text-align: left">ライズ</label>
                                               </c:if>
                                           <%--</form:label>--%>
                                       </div>
                                   </div>
                                   ...
                                   <div class="item form-group">
                                       ...
                                       <label class="control-label col-md-1 col-sm-3 col-xs-12" for="">管理店UUID <span
                                               class="required"></span>
                                       </label>
                                       <div class="col-md-2 col-sm-6 col-xs-12">
                                           <form:input path="shopUuid" id="shopUuid" value="${roleFrom.shopUuid}"
                                                       class="form-control col-md-7 col-xs-12" name="shopUuid"
                                                       required="" type="text"/>
                                       </div>
                                   </div>
                                   <div class="item form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/role/list/" style="width: 100px;">キャンセル</a>
