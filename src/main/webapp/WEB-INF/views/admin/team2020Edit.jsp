                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <br/>
                                <form:form modelAttribute="form" id="userForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/team2020/update/"
                                           class="form-horizontal form-label-left">
                                    <form:hidden path="id" ></form:hidden>
                                <div class="item form-group" style="padding-left: 125px;">
                                    <label class="control-label col-md-2 col-sm-3 col-xs-12" for=""  style="width: 110px;">名前<span
                                            class="required">*</span>
                                    </label>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-8 col-sm-7 col-xs-12 ">
                                        ...
                                        <c:forEach items="${form.urlList}" var="url">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div><img src="${url}" class='file-preview-image kv-preview-data  col-md-4 col-sm-4 col-xs-12'
                                                          style='width:80%;height:260px;' alt='' title=''></div>
                                            </div>
                                        </c:forEach>
                                    </div>
                                </div>
