                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div >
                                <form id="userForm" class="form-horizontal form-label-left input_mask" method="post">
                                    ...
                                    <%--<div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">--%>
                                        ...
                                        <%--<input type="text" class="form-control has-feedback-left" id="goodsName"--%>
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control has-feedback-left" id="serialNumber"
                                               placeholder="番号"  data-rule-maxlength="16" data-rule-serialNo="true">
                                    </div>
                                    <label class="control-label col-md-1 col-sm-1 col-xs-12">購入状態</label>
                                    <div class="col-md-2 col-sm-1 col-xs-12 form-group has-feedback">
                                        <select class="form-control has-feedback-left" id="status" style="-webkit-appearance: none; padding-left: 45px;">
                                            ...
                                            <option value="1">支払完了</option>
                                            <option value="2">未支払い</option>
                                            <option value="3">出荷が完了</option>
                                            <option value="4">返品申請</option>
                                            <option value="5">取引完了</option>
                                        </select>
                            ...
                            <div class="table-responsive">
                                <table id="goodsPurchaseListTable" class="table table-striped jambo_table bulk_action">
                                    <thead>
                                    <tr class="headings">
                                        <th class="column-title" style="">番号</th>
                                        <th class="column-title" style="">金額</th>
                                        <th class="column-title" style="">購入状態</th>
                                        <th class="column-title" style="">日期</th>
...
<div id="goodsPurchaseLoading" style="display: none" class="loading">
    <div class="loading-text">Processing...</div>
</div>
<div class="modal fade delete-goodsPurchase-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    }, $.validator.format("有効な番号を入力してください。"));
    ...
    var datatable = $('#goodsPurchaseListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/goods/purchase/list/',
            type: 'POST',
            data: function (data) {
                // data.goodsName = $('#goodsName').val();
                data.orderId = $('#serialNumber').val();
                data.paymentType = $('#status').val();
        ...
        order: [[ 0, 'asc' ]],
        columns: [
            { data: "orderId", name: "order_id"},
            { data: "amount", name: "amount" },
            { data: "paymentTypeStr", name: "paymentTypeStr" },
            { data: "updateDatetime", name:"updateDatetime",
    ...
    var currDeleteGoodsPurchaseId = 0;
    ...
    function gotoDelete(id) {
        currDeleteGoodsPurchaseId = id;
        $('.delete-goodsPurchase-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#goodsPurchaseLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/goods/purchase/edit/' + id + '/';
    }

    function gotoRegist() {
        $('#goodsPurchaseLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/goods/purchase/regist/';
    }

    function confirmDeleteClick() {
        $('.delete-goodsPurchase-modal').modal("hide");
        $('#goodsPurchaseLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/goods/purchase/delete/' + id + '/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='id'/>");
        input1.attr('value', currDeleteGoodsPurchaseId);
        form.append(input1);
        form.appendTo("body");
