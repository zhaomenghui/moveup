                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br/>
                                <form:form modelAttribute="studioNewsForm" id="studioNewsForm" enctype="multipart/form-data" method="post"
                                           class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/admin/studio/regist/">
                                    <div class="item form-group">
                                        ...
                                        <div>
                                            ...
                                            <div class="col-md-1 col-sm-6 col-xs-12">
                                                <form:input path="sortScore" type="text" id="sortScore" name="sortScore" required="required"
                                                            class="form-control col-md-7 col-xs-12"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-4 col-xs-12">
                                            ...
                                            <div class="col-md-12 col-sm-7 col-xs-12 ">
                                                <form:input type="file" id="picFile" name="picFile" path="picFile" class="form-control col-md-7 col-xs-12" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-8 col-sm-7 col-xs-12 ">
                                            ...
                                            <form:input type="file" id="picFile1" path="picFile1" required=""
                                                        class="form-control col-md-7 col-xs-12" multiple="multiple"  />
                                        </div>
                                    </div>
...
<script>
    $('#picFile').fileinput({'language':'ja', 'showClose': true, 'showRemove':false, 'showUpload':false, 'previewFileType':'any', 'autoReplace':true,"minImageWidth":550,"maxImageWidth":550,"minImageHeight":350,"maxImageHeight":350
        <c:if test="${studioNewsForm.picUrl != null && studioNewsForm.picUrl != ''}">
        , 'uploadUrl':null, 'initialPreview': [
            "<img src='${studioNewsForm.picUrl}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"
        ]
        </c:if>
    });
    $('#picFile1').fileinput({
    ...
    var $studioNewsForm = $("#studioNewsForm");
    $studioNewsForm.validate({
