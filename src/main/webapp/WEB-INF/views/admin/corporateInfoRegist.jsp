                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form modelAttribute="form" id="userForm" enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/corporateinfo/regist/"
                                    ...
                                    <div class="item form-group" id="shopRadio" >
                                        ...
                                        <div class="radio" id="radio" onchange="search()">
                                            ...
                                            <label>
                                                <form:radiobutton path="adminShop" value="2"
                                                                  id="optionsAdminShopRadios2"
                                                                  name="AS"/> 管理店UUID入力
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <label class="control-label " style="text-align: left">コーポレートインフォリスト</label>
                                        </div>
                                        <div id="genre" >
                                    ...
                                    <div class="item form-group" id="shopName" >
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">企業名 <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                    ...
                                    <%--<div class="item form-group" id="desc6" >--%>
                                        ...
                                        <%--</label>--%>
                                        <%--<div class="col-md-6 col-sm-6 col-xs-12">--%>
                                            <%--<form:textarea path="desc6" id="desc6" class="form-control col-md-7 col-xs-12"--%>
                                    ...
                                    <div class="item form-group" id="desc1" >
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" >
                                            <form:input path="desc1" id="desc1editor" class="form-control col-md-7 col-xs-12"
                                                           name="" required="required" type="hidden" style="height: 300px;"/>
                                            <div class="x_content">
                                    ...
                                    <div class="item form-group" id="desc10" >
                                        ...
                                        <%--</div>--%>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:input path="desc10" id="desc10editor" class="form-control col-md-7 col-xs-12"
                                    ...
                                    <div class="item form-group" id="walkTime" >
                                        ...
                                        <div class="col-md-1 col-sm-1 col-xs-12">
                                            <form:input path="walkTime" type="text" id="walkTime" name="" class="form-control co2-md-1 col -sm-6 col-xs-12"/>
                                        </div>
                                    </div>
                                    <div class="item form-group" id="coor" >
                                        <label class="control-label col-md-3 col-sm-1 col-xs-12" for="">座標X<span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-2 col-sm-1 col-xs-12">
                                            <form:input path="coordinate1" id="coordinate1" type="text" name="coordinate1"
                                        ...
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">座標Y <span
                                                class="required">*</span></label>
                                        <div class="col-md-2 col-sm-1 col-xs-12">
                                            <form:input path="coordinate2" id="coordinate2" type="text" name="coordinate2"
                                                        required="required" class="form-control co2-md-1 col -sm-6 col-xs-12"/>
                                        </div>
                                    </div>
                                    <div class="item form-group" id="date">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="publishStart">掲載開始日<span
                                                class="required"></span> </label>
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <form:input path="publishStart" type="date" id="publishStart" name="publishStart"
                                                        class="form-control col-md-7 col-xs-12"/>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="publishEnd">掲載終了日<span
                                                class="required"></span> </label>
                                        <div class="col-md-2 col-sm-6 col-xs-12">
