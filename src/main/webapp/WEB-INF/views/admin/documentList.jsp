                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div>
                                <form:form modelAttribute=" " class="form-horizontal form-label-left input_mask">
                                </form:form>
                            </div>
                            <div class="table-responsive">  <!-- todo LIKE -->
                                <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                    <tr class="headings">
                                        <th class="column-title">ファイル名</th>
                                        <th class="column-title">日付</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr class="even pointer">
                                        <td class=" " ><a target="_blank" href="${pageContext.request.contextPath}/static/file/JMUW_WEB.pdf">JMUW_WEB営業資料.pdf</a></td>
                                        <td class=" ">2018年5月4日</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class="col-md-9 col-sm-9 col-xs-12"></div>
