                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/schedule/regist/"
                                ...
                                <div class="table-responsive">
                                    <table id="scheduleListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
...
<div class="modal fade delete-schedule-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#scheduleListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            {
                ...
                render: function (data, type, full, meta) {
                    if(full.type==1){
                        return '<button type="button" class="btn btn-primary" style="width: 80px;">WORK</button>';
                    }
                    if(full.type==2){
                        return '<button type="button" class="btn btn-danger" style="width: 80px;">FAMILY</button>';
                    }
                    if(full.type==3){
                        return '<button type="button" class="btn btn-success" style="width: 80px;">FRIEND</button>';
                    }
                    if(full.type==0){
    ...
    function gotoDelete(id) {
        currDeleteScheduleId = id;
        $('.delete-schedule-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#scheduleLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/schedule/edit/' + id + '/';
    }
    ...
    function gotoRegist() {
        $('#scheduleLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/schedule/regist/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#scheduleLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/schedule/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='id'/>");
        input1.attr('value', currDeleteScheduleId);
        form.append(input1);
        form.appendTo("body");
