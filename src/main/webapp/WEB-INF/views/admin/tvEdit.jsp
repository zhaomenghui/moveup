            ...
            <div class="">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <form:form modelAttribute="tvRegistForm" enctype="multipart/form-data" method="post"
                                   action="${pageContext.request.contextPath}/admin/tv/update/" id="userForm"
                                   class="form-horizontal form-label-left">
                            <form:hidden path="tvId" ></form:hidden>
                            <form:hidden path="tvDetailId" ></form:hidden>
                            <form:input type="hidden" id="picUrl" path="picUrl" value="${tvRegistForm.picUrl}"/>
                        <div class="x_content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                    <form:select path="type" required="required" data-validate-minmax="10,100"
                                        ...
                                        <c:if test="${tvRegistForm.type ==1}">
                                            <form:option value="1">会員限定</form:option>
                                            <form:option value="2">すべての方</form:option>

                                        </c:if>
                                        <c:if test="${tvRegistForm.type ==2}">
                                            <form:option value="1">会員限定</form:option>
                                            <form:option value="2">すべての方</form:option>
                                        </c:if>
                                    </form:select>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                                    <form:select path="tvType" required="required" data-validate-minmax="10,100"
                                                 class="form-control col-md-7 col-xs-12">
                                        <c:if test="${tvRegistForm.tvType ==1}">SPECIAL</c:if>
                                        <c:if test="${tvRegistForm.tvType ==2}">KIDS</c:if>
                                        <c:if test="${tvRegistForm.tvType ==3}">GIRLS</c:if>
                                        <c:if test="${tvRegistForm.tvType ==4}">LIFE</c:if>
                                        <c:if test="${tvRegistForm.tvType ==5}">OKAYAMA</c:if>
                                        <form:option value="1">SPECIAL</form:option>
                                        <form:option value="2">KIDS</form:option>
                                        <form:option value="3">GIRLS</form:option>
                                        <form:option value="4">LIFE</form:option>
                                        <form:option value="5">OKAYAMA</form:option>
                                    </form:select>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <div>
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                        ...
                                        <form:input type="date" path="date" id="date" class="form-control col-md-3 col-xs-12 "  required="required"/>
                                    </div>
                            ...
                            <div class="form-group" id="s3video"  style="display: none">
                                ...
                                <div class="col-md-6 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-7 col-xs-12 ">
                                        <form:input type="file" id="videoFileLast" name="videoFileLast" path="videoFileLast" class="form-control col-md-3 col-xs-12"/>
                                    </div>
                                </div>
                            </div>
...
<script>
    $('#picFile').fileinput({'language':'ja', 'showClose': true, 'showRemove':false, 'showUpload':false, 'previewFileType':'any', 'autoReplace':true,"minImageWidth":550,"maxImageWidth":550,"minImageHeight":350,"maxImageHeight":350
        <c:if test="${tvRegistForm.picUrl != null && tvRegistForm.picUrl != ''}">
        , 'uploadUrl':null, 'initialPreview': [
            "<img src='${tvRegistForm.picUrl}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"
        ]
        </c:if>
    });
    $('#videoFileFirst').fileinput({'language':'ja', 'showClose': true, 'showRemove':false, 'showUpload':false, 'previewFileType':'any', 'autoReplace':true,"minImageWidth":550,"maxImageWidth":550,"minImageHeight":350,"maxImageHeight":350
        <c:if test="${tvRegistForm.videoFileFirst != null && tvRegistForm.videoFileFirst != ''}">
        , 'uploadUrl':null, 'initialPreview': [
            "<img src='${tvRegistForm.videoFileFirst}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"
        ]
        </c:if>
    });

    $('#videoFileLast').fileinput({'language':'ja', 'showClose': false, 'showRemove':false, 'showUpload':false, 'previewFileType':'any', 'autoReplace':true,"minImageWidth":550,"maxImageWidth":550,"minImageHeight":350,"maxImageHeight":350
        <c:if test="${tvRegistForm.videoFileLast != null && tvRegistForm.videoFileLast != ''}">
        , 'uploadUrl':null, 'initialPreview': [
            "<img src='${tvRegistForm.videoFileLast}' class='file-preview-image kv-preview-data' stype='width:auto;height:auto;max-width:100%;max-height:100%;' alt='Desert' title='Desert'>"
        ]
        </c:if>
    });
