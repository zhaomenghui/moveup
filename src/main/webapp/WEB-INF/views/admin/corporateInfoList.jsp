                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="userForm" class="form-horizontal form-label-left input_mask" method="post">
                                    <div class="col-md-10">
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12">ジャンル</label>
                                        <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                            <span class="fa fa-fire form-control-feedback left" aria-hidden="true"></span>
                                            <input type="text" class="form-control has-feedback-left" id="genre" data-rule-maxlength="30">
                                        </div>
                                        <label class="control-label col-md-1 col-sm-1 col-xs-12">企業名</label>
                                        <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
                                            <span class="fa fa-fire form-control-feedback left" aria-hidden="true"></span>
                                    ...
                                    <div class="col-md-2 text-right" style="padding-right: 15px">
                                        <div style="width: 100px;display: inline-block;">
                                            <a class="btn btn-round btn-success"
                                               href="${pageContext.request.contextPath}/admin/corporateinfo/regist/"
                                ...
                                <div class="table-responsive">
                                    <table id="corporateInfoListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
                                            <th class="column-title" style="width: 15%;">ジャンル</th>
                                            <th class="column-title" style="width: 20%;">企業名</th>
                                            <th class="column-title" style="width: 10%;">電話</th>
                                            <th class="column-title" style="width: 25%;">アドレス</th>
...
<div id="corporateinfoLoading" style="display: none" class="loading">
    <div class="loading-text">Processing...</div>
</div>
<div class="modal fade delete-corporateinfo-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#corporateInfoListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/corporateinfo/list/',
            type: 'POST',
            data: function (data) {
        ...
        order: [[ 1, 'desc' ]],
        columns: [
            { data: "genre", name: "genre", orderable: false },
            { data: "name", name: "name" },
            { data: "tel", name: "tel" },
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, full, meta) {
                    return '<a class="btn btn-primary" style="font-size: inherit;" href="javascript:void(0)" onclick="gotoUpdate('+full.shopListId+')">詳細</a>';
                }
            },
            {
                data: null,
                orderable: false,
                render: function (data, type, full, meta) {
                    return '<button class="btn btn-danger" style="font-size: inherit;" onclick="gotoDelete('+full.shopListId+')">削除</button>';
                }
            }
        ],
        columnDefs: [
    ...
    var currDeleteCorporateInfoId = 0;
    ...
    function gotoDelete(id) {
        currDeleteCorporateInfoId = id;
        $('.delete-corporateinfo-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#corporateinfoLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/corporateinfo/edit/' + id + '/';
    }

    function gotoRegist() {
        $('#corporateinfoLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/corporateinfo/regist/';
    }

    function confirmDeleteClick() {
        $('.delete-corporateinfo-modal').modal("hide");
        $('#corporateinfoLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/corporateinfo/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='shopListId'/>");
        input1.attr('value', currDeleteCorporateInfoId);
        form.append(input1);
        form.appendTo("body");
