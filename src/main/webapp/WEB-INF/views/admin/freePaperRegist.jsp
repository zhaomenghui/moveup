                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <br/>
                                <br/>
                                <form:form modelAttribute="form" id="userForm" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/freepaper/regist/"
                                           class="form-horizontal form-label-left">
                                        <div class="col-md-8 col-sm-12 col-xs-12" style="padding-top: 90px">
                                <div class="col-md-12" >
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="date">日付 <span
                                                class="required">*</span>
                                        </label>
                                        ...
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for=""  style="width: 110px">ボリューム<span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-2 col-sm-6 col-xs-12">
                                            <form:input path="volume" type="" id="volume" name="" required="required"
                                                        class="form-control col-md-7 col-xs-12"/>
                                        </div>
                                        <label class="control-label col-md-1 col-sm-3 col-xs-12" style="width: 113px">TOP表示<span
                                    ...
                                    <div class="col-md-12" style="padding-top: 30px;"></div>
                                    <div class="col-md-12">
                                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="title">タイトル <span
                                                class="required"></span>
                                        </label>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-10 col-sm-7 col-xs-12 ">
                                        <span style="font-size: 16px">表紙画像アップロード</span>
                                        <div class="col-md-12 col-sm-3 col-xs-12">解像度: 1000 X 1500</div>
                                        <form:input type="file" id="picFil1" path="picFil1" required=""
...
<script>
    $('#picFil').fileinput({
        'language':'ja', 'showClose': true, 'showRemove':false, 'showUpload': false, 'previewFileType': 'any',"minImageWidth":1000,"maxImageWidth":1000,"minImageHeight":1500,"maxImageHeight":1500
    })
    $('#picFil1').fileinput({
        'language':'ja', 'showClose': true, 'showRemove':false, 'showUpload': false, 'previewFileType': 'any',"minImageWidth":1000,"maxImageWidth":1000,"minImageHeight":1500,"maxImageHeight":1500
    })
