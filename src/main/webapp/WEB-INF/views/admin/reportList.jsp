                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/report/regist/"
                                ...
                                <div class="table-responsive">
                                    <table id="reportListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
...
<div class="modal fade delete-report-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#reportListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    if(full.type==3){
                        return '<button type="button" class="btn btn-success" style="width: 80px;">REPORT</button>';
                    }
                    if(full.type==0){
    ...
    function gotoDelete(id) {
        currDeleteReportId = id;
        $('.delete-report-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#reportLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/report/edit/' + id + '/';
    }
    ...
    function gotoRegist() {
        $('#reportLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/report/regist/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#reportLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/report/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='id'/>");
        input1.attr('value', currDeleteReportId);
        form.append(input1);
        form.appendTo("body");
