                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="images/img.jpg" alt="">岡山 太郎
                            ...
                            <div class="x_content">
                               ...
                               <form:form modelAttribute="shopRegistForm" id="userForm" enctype="multipart/form-data"
                                   ...
                                   <%--<div class="item form-group"  id="privilege" style="display: none">--%>
                                       <%--<label class="control-label col-md-3 col-sm-1 col-xs-12" for="">権限：--%>
                                       <%--</label>--%>
                                       <%--<div class="col-md-2 col-sm-1 col-xs-12">--%>
                                   ...
                                   <div class="item form-group" id="desc5" style="display: none">
                                       <label class="control-label col-md-3 col-sm-3 col-xs-12" for="desc5">事前予約詳細
                                       </label>
                                       <%--<div class="col-md-6 col-sm-6 col-xs-12">--%>
                                   ...
                                   <div class="item form-group" id="walkTime" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">最寄駅
                                       </label>
                                       <div class="col-md-2 col-sm-1 col-xs-12 form-group has-feedback">
                                       ...
                                       <label class="control-label col-md-2 col-sm-1 col-xs-12" for="">最寄駅徒歩時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12">
                                   ...
                                   <div class="item form-group" id="dayBudget" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">昼間予算
                                       </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                           <form:select path="dayPriceLow" class="form-control">
                                               <form:option value="0">--</form:option>
                                               <c:forEach items="${dayPriceList}" var="str">
                                                   <form:option value="${str.desc}"><fmt:formatNumber value="${str.desc}" pattern="#,###" />円</form:option>
                                               </c:forEach>
                                   ...
                                   <div class="item form-group" id="nightBudget" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">夜間予算
                                       </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                   ...
                                   <div class="item form-group" id="budget" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">予算
                                       </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                   ...
                                   <div class="item form-group" id="" >
                                       ...
                                       <div id="averageBudget"  style="display: none">
                                           <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">平均予算
                                           </label>
                                           <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                   ...
                                   <div class="item form-group" id="foodPrice" style="display: none">
                                       ...
                                       <div class="col-md-1 col-sm-1 col-xs-12" >
                                           <form:select path="foodPrice" class="form-control">
                                               <form:option value="0">--</form:option>
                                               <c:forEach items="${nightPriceList}" var="str">
                                                   <form:option value="${str.content}"><fmt:formatNumber value="${str.desc}" pattern="#,###" />円</form:option>
                                               </c:forEach>
                                   ...
                                   <div class="item form-group" id="dayShopOpenTime" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">昼間開店時間 </label>
                                       ...
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">昼間閉店時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                   ...
                                   <div class="item form-group" id="nightShopOpenTime" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">夜間開店時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                       ...
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">夜間閉店時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group">
                                   ...
                                   <div class="item form-group" id="shopOpenTime" style="display: none">
                                       <div class="col-md-2 col-sm-1 col-xs-12"></div>
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">開店時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                       ...
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">閉店時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
                                       ...
                                       <label class="control-label col-md-1 col-sm-1 col-xs-12" for="">最終受付時間 </label>
                                       <div class="col-md-1 col-sm-1 col-xs-12 form-group ">
