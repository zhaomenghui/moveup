                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="userForm" class="form-horizontal form-label-left input_mask" method="post">
                                    ...
                                    <div class=" col-md-1 text-right" style="padding-right: 15px">
                                        <a class="btn btn-round btn-success"
                                           href="${pageContext.request.contextPath}/admin/freepaper/regist/"
                                ...
                                <div class="table-responsive">
                                    <table id="freePaperListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
                                            <th class="column-title" style="width: 25%;">タイトル</th>
                                            <th class="column-title" style="width: 15%;">ボリューム</th>
...
<div id="freePaperLoading" style="display: none" class="loading">
    <div class="loading-text">Processing...</div>
</div>
<div class="modal fade delete-freePaper-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#freePaperListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
            url: '/admin/freepaper/list/',
            type: 'POST',
            data: function (data) {
    ...
    function gotoDelete(id) {
        currDeleteNewsId = id;
        $('.delete-freePaper-modal').modal("show");
    }

    function gotoUpdate(id) {
        $('#freePaperLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/freepaper/edit/' + id + '/';
    }

    function gotoRegist() {
        $('#freePaperLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/freepaper/regist/';
    }

    function confirmDeleteClick() {
        $('.delete-freePaper-modal').modal("hide");
        $('#freePaperLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/freepaper/delete/');
