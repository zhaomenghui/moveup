                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form modelAttribute="form" id="form" enctype="multipart/form-data" method="post"
                                           class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/admin/entrymail/update/">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="subject" type="text" id="subject" name="subject" required="required"
                                                    class="form-control col-md-7 col-xs-12"/>
                                    </div>
                                </div>
                                <div class="item form-group">
